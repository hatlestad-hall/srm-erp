...
% Wait for a time period equal to a regular run of VEP.
pause_text ( ptb, [ 'Vennligst sitt i ro og lytt til musikken i omtrent 10 minutter.\n\n' ...
	'Når musikken stopper, må du gjøre deg klar for neste oppgave.' ], 3, 3, 600 );
...
% Wait for a time period equal to a regular run of VEP.
pause_text ( ptb, [ 'Vennligst sitt i ro og lytt til musikken i omtrent 3 minutter.\n\n' ...
	'Når musikken stopper, må du gjøre deg klar for neste oppgave.' ], 3, 3, 180 );
...
if strcmpi ( clear_check, 'Yes' ), clear all; end %#ok<CLALL>
